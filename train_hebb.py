...
def main(argv):
    ...
    parser.add_argument('--env_reward', type=bool, default=False, help='Using reward system from the environment')
    ...
    es = EvolutionStrategyHebb(args.hebb_rule, args.environment, args.init_weights, population_size=args.popsize, sigma=args.sigma, learning_rate=args.lr, decay=args.decay, num_threads=args.threads, distribution=args.distribution,use_reward_vector=args.env_reward)
